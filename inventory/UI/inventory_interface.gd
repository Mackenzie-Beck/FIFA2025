...
func set_external_inventory(_external_inventory_data) -> void:
	external_inventory_data = _external_inventory_data
	_external_inventory_data.inventory_interact.connect(on_inventory_interact)
	external_inventory.set_inventory_data(_external_inventory_data)
